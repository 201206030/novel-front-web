      ...
      <div class="my_r">
        <div id="noContentDiv" v-if="total == 0">
          <div class="tc" style="margin-top: 200px">
            <a href="/author/book_add.html" class="btn_red">创建作品</a>
          </div>
        </div>
        <div class="my_bookshelf" id="hasContentDiv" v-if="total > 0">
          <div class="title cf">
            <h2 class="fl">小说列表</h2>
            <div class="fr">
              <a href="/author/book_add.html" class="btn_red">发布小说</a>
            </div>
          </div>
          ...
          <div id="divData" class="updateTable">
            <table cellpadding="0" cellspacing="0">
              ...
              <tbody id="bookList">
                <tr class="book_list" vals="291" v-for="(item, index) in books"
                    :key="index">
                  <td
                  ...
                  <td class="goread" valsc="291|2037554|1">{{item.visitCount}}</td>
                  <td class="goread" valsc="291|2037554|1">0</td>
                  <td class="goread">{{item.lastChapterUpdateTime}} 更新</td>
                  <td class="goread" valsc="291|2037554|1">0</td>
